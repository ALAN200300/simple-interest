...
function App() {
  ...
  const validate =(e)=>{
    ...
    console.log(name);
    console.log(value);
    // match(regExp)- return array when values matches with regular expression
    // else return null
    // ^[0-9]$
  ...
  const calculate = ()=>{
    ...
    <>
      <div className='bg-dark d-flex justify-content-center align-items-center' style={{height:'100vh',width:'100%'}}>
        ...
        <div className='my-3'><TextField id="outlined-basic" className='w-100' value={Principle} name='principle' label="₹ Principle Amount" variant="outlined"  onChange={(e)=>validate(e)}/>
        ...
        <div className="mb-3 d-flex justify-content-between"><Button disabled={isPrinciple && isRate && isYear? false : true} variant="contained" style={{width:'190px'}}  color='success'className='p-3' onClick={calculate}>Calculate</Button>
      <Button variant="outlined" style={{width:'190px'}} className='p-3' onClick={handleReset}>Reset</Button></div>
